...
- Closed-form MSD, NGP, radial van Hove distribution, self-intermediate
  ...
  decoupling diagnostics, activated-barrier gap diagnostic, renewal-count
  susceptibility, peak diagnostics, finite-time peak/late-NGP consistency
  diagnostics, and scattering-transport observable inversion.
